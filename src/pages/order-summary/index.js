...
export default function OrderSummary() {
    const [fullName, setFullName] = useState("Jordan Olivas");
    ...
    return (<div className="flex flex-col md:flex-row bg-crm-dark h-full overflow-y-scroll">
